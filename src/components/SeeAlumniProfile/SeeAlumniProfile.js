...
const SeeAlumniProfile = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://iiuc-campus-recuitement-system.herokuapp.com/profile/watch/alumni/${_id}`)
            .then(response => {
                setUserInfo(response.data.alumniProfile)
...
export default SeeAlumniProfile;