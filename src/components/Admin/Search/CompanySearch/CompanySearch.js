...
const CompanySearch = () => {
    ...
    const handleUserSearch = () => {
        console.log("Clicked")
        axios.get(`https://iiuc-campus-recuitement-system.herokuapp.com/admin/search/company?search=${userInput}`)
            .then(response => {
                console.log(response.data)
                setUsers(response.data.company)
        ...
        <div>
            ...
            <div class="main">
                <div class="input-group">
                    <input type="text" onChange={(e) => setUserInput(e.target.value)} class="form-control" placeholder="Search Company" />
