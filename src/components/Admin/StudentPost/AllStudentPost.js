...
const AllStudentPost = () => {
    ...
    return (
        <div>
            <h2 className="mt-5 text-center">All Student Blogs</h2>
            {
                posts.map(post => {
                        ...
                        <div>
                            ...
                            <div className="row mt-5">
                                ...
                                <div className="m-auto p-3 col-md-6" style={{ boxShadow: 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px' }}>
                                    ...
                                    <button onClick={() => handleDelelteUserPost(_id)} className="btn btn-danger">Delete</button>
                                </div>
                            </div>
                        </div>
                    )
